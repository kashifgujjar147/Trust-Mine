...
export const depositSchema=z.object({packageId:z.string().min(1),method:z.string().min(1),amount:z.coerce.number().positive(),reference:z.string().trim().min(2).max(200),proofUrl:z.string().url()});
