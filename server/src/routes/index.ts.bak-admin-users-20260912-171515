...
route.get('/admin/dashboard',...adminAuth,c.adminDashboard);route.get('/admin/users',...adminAuth,c.adminUsers);route.get('/admin/packages',...adminAuth,c.adminPackages);route.post('/admin/packages',...adminAuth,c.createPackage);route.patch('/admin/packages/:id',...adminAuth,c.updatePackage);route.delete('/admin/packages/:id',...adminAuth,c.archivePackage);route.get('/admin/deposits',...adminAuth,c.adminDeposits);route.post('/admin/deposits/:id/verify',...adminAuth,c.verifyDeposit);route.post('/admin/deposits/:id/reject',...adminAuth,c.adminDepositReject);route.get('/admin/withdrawals',...adminAuth,c.adminWithdrawals);route.post('/admin/withdrawals/:id/approve',...adminAuth,c.adminWithdrawalApprove);route.post('/admin/withdrawals/:id/reject',...adminAuth,c.adminWithdrawalReject);route.post('/admin/withdrawals/:id/processing',...adminAuth,c.adminWithdrawalProcessing);route.post('/admin/withdrawals/:id/complete',...adminAuth,c.adminWithdrawalComplete);
