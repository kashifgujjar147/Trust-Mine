...
- 24-hour cycle scheduler architecture
...
The environment used for packaging did not have a completed dependency install: `npm install` timed out before dependencies were downloaded. The source was audited and rewritten without adding unnecessary packages. Run the commands above in a normal Node/npm environment for the final dependency-installed build.
