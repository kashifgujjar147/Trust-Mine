...
{_id:'pm1',code:'easypaisa',name:'Easypaisa',status:'ACTIVE',instructions:'Send the exact amount to the configured merchant/account and enter the provider reference.',accountDetails:'Demo merchant details — configure in Admin.',minAmount:2,displayOrder:1,verificationMode:'MANUAL'},
...
{_id:'pm3',code:'bank',name:'Bank Transfer',status:'ACTIVE',instructions:'Transfer the exact amount and submit the bank reference. An authorized reviewer verifies it.',accountDetails:'Demo bank details — configure in Admin.',minAmount:2,displayOrder:3,verificationMode:'MANUAL'},
...
export const rewards:RewardTier[]=[
  {_id:'r1',rank:1,name:'Bronze Partner',selfBusiness:10,directRequired:5,indirectRequired:10,teamRequired:15,threshold:50,reward:1,status:'ACTIVE',sortOrder:1},
  {_id:'r2',rank:2,name:'Silver Star',selfBusiness:20,directRequired:10,indirectRequired:20,teamRequired:30,threshold:100,reward:3,status:'ACTIVE',sortOrder:2},
  {_id:'r3',rank:3,name:'Gold Executive',selfBusiness:40,directRequired:15,indirectRequired:40,teamRequired:55,threshold:250,reward:8,status:'ACTIVE',sortOrder:3},
  {_id:'r4',rank:4,name:'Platinum Leader',selfBusiness:80,directRequired:20,indirectRequired:80,teamRequired:100,threshold:500,reward:20,status:'ACTIVE',sortOrder:4},
  {_id:'r5',rank:5,name:'Ruby Manager',selfBusiness:150,directRequired:25,indirectRequired:150,teamRequired:175,threshold:1000,reward:50,status:'ACTIVE',sortOrder:5},
  {_id:'r6',rank:6,name:'Sapphire Director',selfBusiness:300,directRequired:30,indirectRequired:300,teamRequired:330,threshold:2500,reward:120,status:'ACTIVE',sortOrder:6},
  {_id:'r7',rank:7,name:'Emerald Elite',selfBusiness:500,directRequired:35,indirectRequired:500,teamRequired:535,threshold:5000,reward:300,status:'ACTIVE',sortOrder:7},
  {_id:'r8',rank:8,name:'Diamond Ambassador',selfBusiness:1000,directRequired:40,indirectRequired:800,teamRequired:840,threshold:10000,reward:700,status:'ACTIVE',sortOrder:8},
  {_id:'r9',rank:9,name:'Crown Diamond',selfBusiness:2000,directRequired:45,indirectRequired:1200,teamRequired:1245,threshold:25000,reward:1500,status:'ACTIVE',sortOrder:9},
  {_id:'r10',rank:10,name:'Royal Crown Legend',selfBusiness:5000,directRequired:50,indirectRequired:2000,teamRequired:2050,threshold:50000,reward:3500,status:'ACTIVE',sortOrder:10}
];
...
export const withdrawals:Withdrawal[]=[{_id:'w1',transactionId:'WDR-DEMO-001',amount:20,fee:1.6,netAmount:18.4,method:'BEP20',account:'0x••••••demo',accountHolderName:'Demo Member',status:'PENDING',createdAt:iso(-6e5)}];
