...
function Overview({
  ...
  const stats=[
    ...
    ['Deposits',`$${d.deposits.toFixed(2)}`,<Wallet/>],
    ['Pending Deposits',d.pendingDeposits,<ShieldCheck/>],
    ['Withdrawals',`$${d.withdrawals.toFixed(2)}`,<ArrowDownToLine/>],
    ['Active Packages',d.activePackages,<Boxes/>],
    ['Income Distributed',`$${d.incomeDistributed.toFixed(2)}`,<ReceiptText/>],
    ['Rewards Distributed',`$${d.rewardsDistributed.toFixed(2)}`,<Gift/>]
  ];
        ...
        <Card>
          ...
          <div className="admin-list">
            ...
            <div>
              ...
              <b>${d.commissionDistributed.toFixed(2)}</b>
            </div>
          </div>
        </Card>
      ...
      <Table headers={['Package','Amount','Daily','Duration','Status','Actions']}>
        {items.map(p=>(
          <tr key={p._id}>
            ...
            <td>
              ${p.incomeConfiguration.daily.toFixed(2)}
            </td>
...
function ReviewDeposits({
  ...
  return (
    <Card>
      ...
      <Table headers={['Deposit','Package','Amount','Method','Status','Date','Actions']}>
        {rows.map(d=>(
          <tr key={d._id}>
            <td>
              <b>{d.transactionId}</b>
          ...
          <>
            <div className="settings-list">
              ...
              <div>
                ...
                <b>${s.minimumDeposit}</b>
              </div>

              <div>
                <span>Minimum withdrawal</span>
                <b>${s.minimumWithdrawal}</b>
              </div>
